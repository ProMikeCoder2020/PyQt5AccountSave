...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.stackedWidget.setGeometry(QtCore.QRect(150, 70, 261, 201))
        self.stackedWidget.setObjectName("stackedWidget")
        self.page = QtWidgets.QWidget()
        self.page.setObjectName("page")
        self.gridLayoutWidget = QtWidgets.QWidget(self.page)
        self.gridLayoutWidget.setGeometry(QtCore.QRect(60, 39, 160, 101))
        ...
        self.a = QtWidgets.QDateEdit(self.page)
        self.a.setGeometry(QtCore.QRect(100, 10, 110, 22))
        self.a.setObjectName("a")
        self.stackedWidget.addWidget(self.page)
        self.page_2 = QtWidgets.QWidget()
        self.page_2.setObjectName("page_2")
        self.gridLayoutWidget_2 = QtWidgets.QWidget(self.page_2)
        self.gridLayoutWidget_2.setGeometry(QtCore.QRect(29, 59, 211, 121))
